...
var $author$project$Main$RawFields = F7(
	function (id, section, name, dependsOn, estimate, weatherDependent, canExpedite) {
		return {canExpedite: canExpedite, dependsOn: dependsOn, estimate: estimate, id: id, name: name, section: section, weatherDependent: weatherDependent};
	});
